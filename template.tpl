...

{
  ...
  "description": "Web analytics pixel for web and server tracking.",
  "containerContexts": [
    "WEB"
  ]
}
    ...
    "subParams": [
      {
        "type": "TEXT",
        "name": "scriptDomain",
        "displayName": "Script domain",
        "simpleValueType": true,
        "help": "(Optional) Enter the domain to retrieve the web-pixel.js file.  If this field is blank, then it will default to the same domain as the server endpoint.  By default, the domain is set to cdn.datm.cc.",
        "defaultValue": "cdn.datm.cc"
      },
      {
        "type": "TEXT",
        "name": "serverDomain",
...
// Tag config
const scriptDomain = data.scriptDomain;
...
const scriptSource = 'https://' + (scriptDomain || serverDomain) + '/web-pixel.min.js';
